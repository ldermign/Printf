...
/*   Updated: 2021/02/26 11:54:56 by ldermign         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	// check_printf(size_ft_printf, size_printf);
	...
	// check_printf(size_ft_printf, size_printf);
		size_printf = printf(KGRN"[-2.-2s] -------> [%*.*s].\n", -2, -2, n);
	size_ft_printf = ft_printf(KCYN"[-2.-2s] -------> [%*.*s].\n", -2, -2, n);
	check_printf(size_ft_printf, size_printf);
	size_printf = printf(KGRN"[-2.-2s] -------> [%*.*s].\n", -2, -2, o);
	size_ft_printf = ft_printf(KCYN"[-2.-2s] -------> [%*.*s].\n", -2, -2, o);
	check_printf(size_ft_printf, size_printf);
	...
	size_ft_printf = ft_printf(KCYN"[-2.-2s] -------> [%*.*s].\n", -2, -2, u);
	check_printf(size_ft_printf, size_printf);
		size_printf = printf(KGRN"[-2.0s] -------> [%*.*s].\n", -2, 0, n);
	size_ft_printf = ft_printf(KCYN"[-2.0s] -------> [%*.*s].\n", -2, 0, n);
	check_printf(size_ft_printf, size_printf);
	size_printf = printf(KGRN"[-2.0s] -------> [%*.*s].\n", -2, 0, o);
	size_ft_printf = ft_printf(KCYN"[-2.0s] -------> [%*.*s].\n", -2, 0, o);
	check_printf(size_ft_printf, size_printf);
	...
	size_ft_printf = ft_printf(KCYN"[-2.0s] -------> [%*.*s].\n", -2, 0, u);
	check_printf(size_ft_printf, size_printf);
	size_printf = printf(KGRN"[-2.1s] -------> [%*.*s].\n", -2, 1, n);
	size_ft_printf = ft_printf(KCYN"[-2.1s] -------> [%*.*s].\n", -2, 1, n);
	check_printf(size_ft_printf, size_printf);
	size_printf = printf(KGRN"[-2.1s] -------> [%*.*s].\n", -2, 1, o);
	size_ft_printf = ft_printf(KCYN"[-2.1s] -------> [%*.*s].\n", -2, 1, o);
	check_printf(size_ft_printf, size_printf);
